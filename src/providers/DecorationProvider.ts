...
import { DecorationRenderOptions as RenderOptions } from 'vscode';
...
export const hiddenCommentDecoration = vscode.window.createTextEditorDecorationType(<RenderOptions>{ 
	color: "transparent", backgroundColor: "transparent", opacity: "0.0"
});


export const linkedCommentDecoration = vscode.window.createTextEditorDecorationType(<RenderOptions>{ 
...
export const highlighterDecoration = vscode.window.createTextEditorDecorationType(<RenderOptions>{
...
export function CreateDecoration(colour:string, backgroundColour:string, overline=false, strikethrough=false, underline=false, bold=false, italic=false) {
	...
	let options = <RenderOptions>{ color: colour, backgroundColor: backgroundColour, textDecoration: "" };
