...
namespace CharCodes {
	...
	export function IsWhiteSpace(charCode: number): bool {
		return (
			charCode === CharCode.Space ||
			charCode === CharCode.Tab ||
			charCode === CharCode.None || 
			charCode === CharCode.CarriageReturn ||
			charCode === CharCode.NewLine ||
			charCode === CharCode.LINE_SEPARATOR ||
			charCode === CharCode.PARAGRAPH_SEPARATOR ||
			charCode === 0x2B7F
		);
	}
